...
@section('content')
  ...
  <div class="page_content">
    ...
    {!! Form::open(['url' => 'systeem/gebruikers/opslaan', 'class' => 'custom_form_container', 'files' => true]) !!}
        ...
        <div class="custom_form">
          ...
          <div class="grid-x grid-margin-x">
            ...
            <div class="cell small-12 medium-6 xlarge-4 @if ($errors->has('roles_id')) has-error @endif">
              ...
              <div class="custom_select_input">
                {!! Form::select(null, $roles, old('roles_id'), ['name' => 'roles_id', 'id' => 'inputRole', 'class' => '']) !!}
              </div>
            </div>
          </div>
          ...
          <div class="grid-x grid-margin-x">
            ...
            <div class="cell small-12 medium-6 xlarge-4 @if ($errors->has('username')) has-error @endif">
              ...
              {!! Form::text('inputUsername', old('username'), ['name' => 'username', 'class' => '', 'placeholder' => 'Username']) !!}
            </div>

            {{-- Email --}}
            <div class="cell small-12 medium-6 xlarge-4 @if ($errors->has('email')) has-error @endif">
              {!! Form::label('inputEmail', 'Email') !!}
              {!! Form::email('inputEmail', old('email'), ['name' => 'email', 'class' => '', 'placeholder' => 'example@gmail.com']) !!}
            </div>
          ...
          <div class="grid-x grid-margin-x">
            ...
            <div class="cell small-12 medium-6 xlarge-4 upload_button upload_avatar @if ($errors->has('avatar')) has-error @endif">
              <div class="avatar avatar_preview" style="background-image: url('/uploads/avatar/no_avatar.jpg');"></div>
